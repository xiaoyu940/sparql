...
class TestJoin001(TestCaseBase):
    """测试两表JOIN基础: employees 和 departments"""
    ...
    def sparql_query(self) -> QueryResult:
        ...
        # 验证生成的 SQL 包含预期模式
        expected_patterns = ["COUNT", "department_name", "GROUP BY"]
        excluded_patterns = []
...
if __name__ == '__main__':
    ...
    result = run_test_case(TestJoin001, db_config)
