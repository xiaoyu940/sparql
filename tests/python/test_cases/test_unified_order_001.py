...
class TestOrd001(TestCaseBase):
    """测试ASC排序: departments"""
    
    def sparql_query(self) -> QueryResult:
        """
        SPARQL 查询: 获取部门名称并按升序排列
        ...
        # 验证生成的 SQL 包含预期模式
        expected_patterns = ["department_name", "SELECT"]  # 放宽检查
        excluded_patterns = []
...
if __name__ == '__main__':
    ...
    result = run_test_case(TestOrd001, db_config)
