...
text=text.replace('''      BackgroundWorkerBuilder::new("rs_ontop_core SPARQL Web Gateway")
...
new2='''          if table_nodes.is_empty() {
              ...
              let mut result = table_nodes[0].1.clone();
'''
text3=text3.replace(old2,new2,1)
p3.write_text(text3,encoding='utf-8')
print('applied hardening patches confirmed write')